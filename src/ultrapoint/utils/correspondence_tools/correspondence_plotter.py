...
def plot_correspondences(
    images, uv_a, uv_b, use_previous_plot=None, circ_color="g", show=True
):
...
def plot_correspondences_from_dir(
    log_dir, img_a, img_b, uv_a, uv_b, use_previous_plot=None, circ_color="g", show=True
):
