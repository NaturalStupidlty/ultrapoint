...
class Apollo(Coco):
    ...
    def read_images_files_from_folder(self, drive_path, file="train.txt", cam_id=1):
        ...
        img_files = [
            ...
            f"{str(drive_path)}/{frame[:-8]}/{frame[-7:-1]}"
            for frame in open(frame_list_path)  # due to the output test file
    ...
    def crawl_folders(self, sequence_length):
        ...
        logger.info("Finished crawl_folders for KITTI.")
